...
public class ChunkProviderStrawberryDimension implements IChunkProvider
{
    /** RNG. */
    private Random rand;
    ...
    public ChunkProviderStrawberryDimension(World par1World, long par2, boolean par4)
    {
                    ...
                    for (int l1 = 0; l1 < 8; ++l1)
                    {
                        ...
                        for (int i2 = 0; i2 < 4; ++i2)
                        {
                            ...
                            for (int k2 = 0; k2 < 4; ++k2)
                            {
                                if ((d16 += d15) > 0.0D)
                                {
                                    par3ArrayOfByte[j2 += short1] = (byte)testMod.fireDirt.blockID;
                                }
                                else
                                {
            ...
            for (int l = 0; l < 16; ++l)
            {
                ...
                for (int k1 = 127; k1 >= 0; --k1)
                {
                    ...
                    else
                    {
                        ...
                        else if (b3 == testMod.fireDirt.blockID)
                        {
                            if (j1 == -1)
                            {
                                if (i1 <= 0)
                                {
                                    b1 = 0;
                                    b2 = (byte)testMod.fireDirt.blockID;
                                }
