...
public class fireWorldGenTrees extends WorldGenerator
{
    ...
    public fireWorldGenTrees(boolean par1)
    {
        this(par1, 4, 0, 0, false);
    }

    public fireWorldGenTrees(boolean par1, int par2, int par3, int par4, boolean par5)
    {
        super(par1);
                        ...
                        if (i1 >= 0 && i1 < 256)
                        {
                            ...
                            if (!isAir &&
                               !block.isLeaves(par1World, l1, i1, j1) &&
                                ...
                                k1 != testMod.fireDirt.blockID &&
                                k1 != testMod.fireGrass.blockID &&
                                k1 != Block.cake.blockID &&
            ...
            else
            {
                ...
                if (isSoil && par4 < 256 - l - 1)
                {
                        ...
                        for (j2 = par3 - i2; j2 <= par3 + i2; ++j2)
                        {
                            ...
                            for (int l2 = par5 - i2; l2 <= par5 + i2; ++l2)
                            {
                                ...
                                if (Math.abs(k2) != i2 || Math.abs(i3) != i2 || par2Random.nextInt(2) != 0 && k1 != 0)
                                {
                                    ...
                                    {
                                        this.setBlockAndMetadata(par1World, j2, j1, l2, Block.cake.blockID, this.metaLeaves);
                                    }
                                }
                            }
                        }
                    ...
                    for (j1 = 0; j1 < l; ++j1)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, par3, par4 + j1, par5, block.blockDiamond.blockID, this.metaWood);

                            if (this.vinesGrow && j1 > 0)
                            {
                                if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3 - 1, par4 + j1, par5))
                                {
                                    this.setBlockAndMetadata(par1World, par3 - 1, par4 + j1, par5, Block.cake.blockID, 8);
                                }

                                if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3 + 1, par4 + j1, par5))
                                {
                                    this.setBlockAndMetadata(par1World, par3 + 1, par4 + j1, par5, Block.cake.blockID, 2);
                                }

                                if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3, par4 + j1, par5 - 1))
                                {
                                    this.setBlockAndMetadata(par1World, par3, par4 + j1, par5 - 1, Block.cake.blockID, 1);
                                }

                                if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3, par4 + j1, par5 + 1))
                                {
                                    this.setBlockAndMetadata(par1World, par3, par4 + j1, par5 + 1, Block.cake.blockID, 4);
                                }
                            }
                        }
                    }
                            ...
                            for (j1 = 0; j1 < 2; ++j1)
                            {
                                for (k1 = 0; k1 < 4; ++k1)
                                {
                                    if (par2Random.nextInt(4 - j1) == 0)
                                    {
                                        ...
                                        this.setBlockAndMetadata(par1World, par3 + Direction.offsetX[Direction.rotateOpposite[k1]], par4 + l - 5 + j1, par5 + Direction.offsetZ[Direction.rotateOpposite[k1]], Block.cake.blockID, i2 << 2 | k1);
                                    }
                                }
                            }
                        }
    ...
    {
        this.setBlockAndMetadata(par1World, par2, par3, par4, Block.cake.blockID, par5);
        int i1 = 4;
