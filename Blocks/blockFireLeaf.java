...
import f01405.TestMod.World.ColorizeLeaves;

public class blockFireLeaf extends BlockLeavesBase implements IShearable
{
    public static final String[] LEAF_TYPES = new String[] {"fire"};
    public static final String[][] field_94396_b = new String[][] {{"leaves_fire"}, {"leaves_fire_opaque"}};
    @SideOnly(Side.CLIENT)
    private int field_94394_cP;
    private Icon[][] iconArray = new Icon[2][];
    int[] adjacentTreeBlocks;

    public blockFireLeaf(int par1)
    {
    ...
    {
    	if ((par1 & 3) == 0) {
        return ColorizeLeaves.getFoliageColorFire();
    	}
    	else {
    		return ColorizeLeaves.getFoliageColorFire();
    	}
    ...
    {
        return testMod.fireSapling.blockID;
    }
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        for (int i = 0; i < field_94396_b.length; ++i)
        {
            ...
            {
                this.iconArray[i][j] = par1IconRegister.registerIcon("testmod:" + field_94396_b[i][j]);
            }
        }
    }
