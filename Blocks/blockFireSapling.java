...
{
    public static final String[] WOOD_TYPES = new String[] {"fire"};
    ...
    public void growTree(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        else if (l == 3)
        {
            ...
            if (object == null)
            {
                j1 = 0;
                i1 = 0;
                object = new fireWorldGenTrees(true, 4 + par5Random.nextInt(7), 3, 3, false);
            }
        }
        else
        {
            object = new fireWorldGenTrees(true);
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.saplingIcon[i] = par1IconRegister.registerIcon("testmod:sapling_" + WOOD_TYPES[i]);
        }
    }
}
